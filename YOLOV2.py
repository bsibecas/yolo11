...
# Cargar modelo YOLOv11 preentrenado (puedes usar 'yolov8n.pt' si 'yolov11n.pt' no existe)
model = YOLO("yolo11n.pt")  # O reemplaza por "yolov8n.pt" si no tienes el v11
...
# Consolidar trayectorias de cada objeto
merged_tracks = {}
...
cap.release()
out.release()
print("✅ Video con tracking generado: tracked_comma_output.avi")
